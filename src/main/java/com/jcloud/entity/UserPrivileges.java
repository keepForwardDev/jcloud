...
import com.jcloud.core.domain.AutoIdModel;
import lombok.Data;
...
@Data
@Entity
@Table(name = "sys_user_privileges", indexes = {@Index(columnList = "userId,resourceType, serviceId")})
@TableName("sys_user_privileges")
@org.hibernate.annotations.Table(appliesTo = "sys_user_privileges", comment = "个人用户权限")
public class UserPrivileges extends AutoIdModel<UserPrivileges> {

    @Column(columnDefinition = "bigint(20) comment '所属用户ID'")
    private Long userId;
    ...
    @Column(columnDefinition = "int(11) comment '资源排序号'")
