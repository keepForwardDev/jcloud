...
public class ArithmeticUtil {
     ...
     * @return
     */
    public static Double roundDouble(String v, int scale) {
        if (scale < 0) {
            throw new IllegalArgumentException(
                    "The scale must be a positive integer or zero");
        }
        if (StringUtils.isBlank(v)) return 0d;
        BigDecimal b = new BigDecimal(v);
        BigDecimal one = new BigDecimal("1");
    ...
    public static double div2(String v1, String v2, int scale) {
        if (StringUtils.isBlank(v1) || StringUtils.isBlank(v2) || StringUtils.equalsIgnoreCase("0", v2)) return 0l;
        if (scale < 0) {
            throw new IllegalArgumentException(
                    "The scale must be a positive integer or zero");
        }
    ...
    public static String strDiv(String v1, String v2, int scale) {
        ...
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        BigDecimal num = b1.divide(b2, scale, BigDecimal.ROUND_HALF_UP);
        return num.multiply(new BigDecimal(100)).toString();
    }
     ...
     * @return 两个参数的商
     */
    public static Integer strDivByInt(String v1, String v2, int scale) {
        if (scale < 0) {
            throw new IllegalArgumentException(
                    "The scale must be a positive integer or zero");
        }
    ...
    public static double divByDouble(int v1, int v2, int scale) {
        if (scale < 0) {
            throw new IllegalArgumentException(
                    "The scale must be a positive integer or zero");
        }
        ...
        BigDecimal b2 = new BigDecimal(v2);
        BigDecimal num = b1.divide(b2, scale, BigDecimal.ROUND_HALF_UP);
        return num.multiply(new BigDecimal(100)).doubleValue();
    }
    ...
    public static void main(String[] args) {
        //Double s=roundDouble(HtmlUtil.deleteChineseWord("50.3652人民币"), 3);
